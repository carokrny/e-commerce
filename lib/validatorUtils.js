 ...
 */
 module.exports.validateAddressInputs = (data) => {
    ...
    const { address1, 
        ...
        zip,
        country,
        is_primary_address,        // can be null 
        first_name, 
        last_name,
        user_id 
    } = data;
    ...
    if ( address1 === null        || typeof address1   !== 'string'  ||
        ...
        (is_primary_address !== null && (typeof is_primary_address !== 'boolean')) ||
...
module.exports.validatePaymentInputs = (data) => {
    ...
    const { 
        ...
        exp_year,
        billing_address_id,     
        is_primary_payment,       // can be null
        user_id 
    } = data;
    ...
    if (provider === null                   || typeof provider !== 'string'         ||
        card_no === null                    || typeof card_no !== 'string'          ||
        cvv === null                        || typeof cvv !== 'string'              ||
        ...
        (card_type !== null && (typeof card_type !== 'string' || !(card_type === 'credit' || card_type === 'debit')))
    ) {
